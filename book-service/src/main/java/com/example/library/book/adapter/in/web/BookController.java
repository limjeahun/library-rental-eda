...
import com.example.library.book.adapter.in.web.request.BookRequest;
import com.example.library.book.adapter.in.web.response.BookResponse;
...
/**
 * 도서 등록, 도서 조회, 대여 가능/불가능 상태 변경 HTTP 요청을 처리하는 REST 컨트롤러.
 */
@RestController
...
public class BookController {
     ...
     * 새 도서 등록.
     *
     * @param request 도서 제목, 설명, 분류, 위치를 담은 등록 요청 본문 DTO.
     * @return 등록된 도서 정보 HTTP 응답 DTO.
     */
    @PostMapping
