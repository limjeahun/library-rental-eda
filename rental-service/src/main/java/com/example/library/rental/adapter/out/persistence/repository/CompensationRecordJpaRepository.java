...
/**
 * rental-service 비즈니스 보상 실행 이력을 저장하고 조회하는 Spring Data repository입니다.
 */
public interface CompensationRecordJpaRepository extends JpaRepository<CompensationRecordJpaEntity, Long> {
    boolean existsByCorrelationIdAndCompensationType(String correlationId, String compensationType);
}
