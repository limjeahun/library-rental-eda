...
public interface CompensationUseCase {
     ...
     */
    void cancelRentItem(IDName idName, Item item, String correlationId);
     ...
     */
    void cancelReturnItem(IDName idName, Item item, long point, String correlationId);
     ...
     * @param point 적립, 차감, 정산 또는 보상에 사용할 포인트 값입니다.
     */
    void cancelMakeAvailableRental(IDName idName, long point, String correlationId);
}
