...
public class BestBookPersistenceAdapter implements FindAllBestBooksPort, FindBestBookByIdPort,
    ...
    /**
     * 모든 MongoDB document 를 조회해 도메인 모델로 변환합니다.
     *
     * @return MongoDB read model 에 저장된 인기 도서 목록을 반환합니다.
     */
    @Override
    ...
    /**
     * document 식별자로 인기 도서 read model 을 조회합니다.
     *
    ...
    /**
     * 도서 번호로 인기 도서 read model 을 조회합니다.
     *
     * @param itemNo 인기 도서 집계 대상 도서 번호입니다.
     * @return 도서 번호에 해당하는 인기 도서 read model 을 담은 Optional 을 반환합니다.
     */
    @Override
    ...
    /**
     * 인기 도서 도메인 모델을 MongoDB document 로 변환해 저장한 뒤 다시 도메인 모델로 반환합니다.
     *
     * @param bestBook 저장하거나 응답 DTO 로 변환할 인기 도서 도메인 모델입니다.
