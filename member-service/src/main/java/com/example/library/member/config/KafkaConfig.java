...
/**
 * 회원 서비스의 Kafka 송수신과 Avro Schema Registry 메시지 변환을 위한 Spring Bean 설정입니다.
 */
@EnableKafka
@Configuration
public class KafkaConfig {
    ...
    /**
     * 결과 이벤트를 Avro 값으로 발행하기 위한 producer factory를 생성합니다.
     *
    ...
    /**
     * KafkaListener 가 사용할 listener container factory를 제공합니다.
     *
